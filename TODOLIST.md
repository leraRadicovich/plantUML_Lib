...
2. Придумать механизм включения и отключения функций, чтобы его можно было перед текстом диаграммы указывать, а не в конце. Вероятно, единственное решение - через легенду. тогда нужно сделать ее склеиваемой из разных блоков. 
...
10. Реализовать на базе карты процесса возможность отрисовки диаграммы в стандартном сиквенсе
